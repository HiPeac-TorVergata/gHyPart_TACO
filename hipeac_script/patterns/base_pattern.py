...
def run_pattern_combination(out, file_path, our_impl, patterns, LOG):
    input.subprocess.call("../build/gHyPart " + file_path + " -bp -wc 0 -useuvm 0 -sort_input 0 > " + LOG, shell=True)
    # input.subprocess.call("../build/gHyPart " + file_path + " -bp -wc 0 -useuvm 0 -sort_input 0 -usenewkernel12 0 -newParBaseK12 1 > " + LOG, shell=True)
